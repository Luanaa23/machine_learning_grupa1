...
# how='' -
# df1 = pd.DataFrame({'ID': [1,2, 3],'Nume':['Ana', 'Bogdan', 'Silviu'], 'Varsta': [25,30,34]}, index = [1,2,3])
# df2 = pd.DataFrame({'ID': [2,3, 4],'Nume':['Cristina', 'David', 'Maria'], 'Varsta': [22,35,21]},  index = [1,2,3])
